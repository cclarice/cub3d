...
/*   Updated: 2021/03/15 22:27:45 by cclarice         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	long_put_error(char *map, int *e)
{
	e[10] != -1 ? PRF("\033[0m  [%.*s]\n\033[31m^   %s\n",
...
void	put_error(char *map, int *e)
{
	...
	e[8] == -1 ? PRF("\033[31m%s\n", E08) : 0;
	e[9] == -1 ? PRF("\033[31m%s\n", E09) : 0;
	long_put_error(map, e);
	e[19] != -1 ? PRF("\033[31m%s\n", E19) : 0;
	e[20] != -1 ? PRF("\033[31m%s\n", E20) : 0;
	e[21] != -1 ? PRF("\033[31m%s\n", E21) : 0;
	e[22] != -1 ? PRF("\033[31m%s\n", E22) : 0;
}
